...
class DealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deal" do
    assert_difference('Deal.count') do
      post deals_url, params: { deal: { book_id: @deal.book_id, contact: @deal.contact, name: @deal.name } }
    end
  ...
  test "should update deal" do
    patch deal_url(@deal), params: { deal: { book_id: @deal.book_id, contact: @deal.contact, name: @deal.name } }
